...
public class Partitioning_101 {
	...
	public static void main(String[] args) {
		...
		Partitioning_101 partitionArray = new Partitioning_101(10);

		partitionArray.generateRandomArray();

		System.out.println(Arrays.toString(Partitioning_101.theArray));
	...
	public void partitionArray(int pivot) {
		...
		while (true) {
			...
			System.out
					.println(theArray[leftPointer] + " in index " + leftPointer
	...
	Partitioning_101(int newArraySize) {
